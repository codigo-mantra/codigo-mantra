...
from tasks.views import TaskViewSet, TaskTypeViewSet, CommentViewSet
...
task_router = routers.NestedSimpleRouter(section_router, r'tasks', lookup='task')
task_router.register(r'comments', CommentViewSet)